...
$if(customType)$
	...
	\setsansfont[
		Path= {/home/ian/.pandoc/quetzacoatl/typefaces/Inter/},
		Extension = {.otf},
		UprightFont = {*-Regular},
		ItalicFont = {*-Italic},
		BoldFont = {*-Bold},
...
$else$
\usepackage[hmargin=2 in, marginparsep=0.0 in]{geometry}
$endif$
...
\hypersetup{breaklinks=true,
            ...
            urlcolor=$if(urlColor)$$urlColor$$else$ruleColor$endif$,
...
\rule{\textwidth-\widthof{\large\textsf{$institution$}} - {1.25 em}}%
