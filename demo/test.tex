...
% Title formatting
    \usepackage[%
     abstract %
            ...
            \renewcommand\QuetzalTitlePageReportNo{FOO-1234}
        
            \renewcommand\QuetzalTitlePageInstitution{Bell Telephone
Laboratories}
...
\cite{bloembergen_1949, portis_1956}; another might be the so-called
