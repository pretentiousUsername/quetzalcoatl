...
% use the [notrig] for no new trig functions, and [italicdiff] for italic
...
$if(urlMarkSymbol)$
	\let\orighref\href
	\renewcommand{\href}[2]{\orighref{#1}{#2{\color{urlMarkColor} \symbolFont{$urlMarkSymbol$}}}} % ugly as sin but it works
$else$

	\let\orighref\href
	\renewcommand{\href}[2]{\orighref{#1}{#2{\color{urlMarkColor} \symbolFont{°}}}}
